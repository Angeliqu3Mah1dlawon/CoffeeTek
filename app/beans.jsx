  ...
  return (
    ...
    <View className="flex-1 bg-[#E8D7B8]">
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        ...
        <Image source={require('../assets/arabica.jpeg')} style={{ width: '100%', height: 200, borderRadius: 10 }} />
        ...
        <Image source={require('../assets/robusta.jpg')} style={{ width: '100%', height: 200, borderRadius: 10 }} />
        <Text className="text-gray-700 mt-2">
        ...
        <Image source={require('../assets/liberica.jpg')} style={{ width: '100%', height: 200, borderRadius: 10 }} />
        <Text className="text-gray-700 mt-2">
        ...
        <Image source={require('../assets/excelsa.jpeg')} style={{ width: '100%', height: 200, borderRadius: 10 }} />
        <Text className="text-gray-700 mt-2">
